...
- **Next:** **Sq-3b** — squad-scoped **acting-Captain appointment** (a Captain-or-CO function + a control in the room; the read side is already wired into CO). Then Sq-4 (squad pages + home/calendar filter). Battles remain the big cross-group / Headquarters future.
