...
- **Next:** run `0035` (staging → prod), deploy Sq-2b; then Sq-3 (squad Operations: picker, scoped notifications, Captain-as-CO, acting Captain), Sq-4 (filters). Battles remain the big cross-group / Headquarters future.
