...
- **Next:** scope + build the **Operation Room** (single-group: roster/roll-call → live room + games-count → close/archive → Service Record). Battles (cross-group + AI evidence) come later.
