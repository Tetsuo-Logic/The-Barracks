...
- **Next:** run `0032` (staging → prod), then Op-2 (live Operation Room UI: roll call, realtime games-count, present roster), Op-3 (close/archive), Op-4 (Service Record + retire the leaderboard).
